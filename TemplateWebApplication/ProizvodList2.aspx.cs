...
{
    public partial class ProizvodList2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (Proizvod item in mm.FindAll((new Proizvod()), "Proizvod", true))
            {
                lt.Add(item);
            }
        ...
        protected void GridView1_OnRowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (int.TryParse(e.CommandArgument.ToString(), out a) && (e.CommandName.Equals("Edit") || e.CommandName.Equals("Delete")))
            {
                ...
                if (a >= 0 && e.CommandName.Equals("Edit")){
                    ...
                    //if (a >=0 && e.CommandName.Equals("Delete"))
                    //{
                    //    Proizvod p = new Proizvod();
                    //    int columnidex = GetColumnIndex(row, Proizvod.GetIDPropertyName());
                    //    string tekst = this.GridView1.Rows[a].Cells[columnidex].Text;
                    //    p.SifraProizvoda = int.Parse(tekst);
                    //    Middletier.MiddletierManager mm = new MiddletierManager();
                    //    mm.Delete(p,true);
        ...
        protected void GridView1_OnRowDeleted(object sender, GridViewDeletedEventArgs gridViewDeletedEventArgs)
        {

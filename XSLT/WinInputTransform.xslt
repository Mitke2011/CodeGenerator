...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="vmargin">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultvmargin"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="hmargin">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaulthmargin"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="labelwidth">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultlabelwidth"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="btnwidth">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultbtnwidth"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="btnheight">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultbtnheight"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="formwidth">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultformwidth"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="formheight">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultformheight"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="minimumcontrolwidth">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultminimumcontrolwidth"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="showprimarykeys">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultshowprimarykeys"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="ondirtyclosingquestion">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultondirtyclosingquestion"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  <xsl:variable name="ondirtyclosingtitle">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="$defaultondirtyclosingtitle"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  ...
  <xsl:template name="PropertyControlInfo" >
    ...
    <xsl:if test="string-length($parentname) > 0">
      ...
      <xsl:if test="$islookup='true'">
        <xsl:attribute name="IsLookup">
          <xsl:value-of select="$islookup"/>
        </xsl:attribute>
        

        <xsl:attribute name="LookupCollection">
          <xsl:value-of select="$parentname"/>
        </xsl:attribute>
        <xsl:attribute name="LookupSingular">
          <xsl:value-of select="$parentname"/>
        </xsl:attribute>

        <xsl:attribute name="LookupName">
          <xsl:value-of select="$parentname"/>
        </xsl:attribute>
      </xsl:if>
    </xsl:if>
    ...
    <xsl:attribute name="ControlPrefix">
      <xsl:value-of select="$prefix" />
    </xsl:attribute>
    <xsl:attribute name="ControlChangedEvent">
      <xsl:value-of select="$changedevent"/>
    </xsl:attribute>
    <xsl:attribute name="ControlName">
      <xsl:value-of select="concat($prefix,$name)"/>
    </xsl:attribute>
    <xsl:attribute name="BindProperty">
      <xsl:value-of select="$bindproperty"/>
    </xsl:attribute>
